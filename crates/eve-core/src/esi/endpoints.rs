...
pub const CATALOG: &[Endpoint] = &[
    ...
    Endpoint {
        key: "planets",
        path: "/latest/characters/{cid}/planets/",
        class: PollClass::Slow,
    ...
    Endpoint {
        key: "calendar",
        path: "/latest/characters/{cid}/calendar/",
        class: PollClass::Slow,
        scope: Some("esi-calendar.read_calendar_events.v1"),
    },
    Endpoint {
        key: "mail",
    ...
    Endpoint {
        key: "contracts",
        path: "/latest/characters/{cid}/contracts/",
        class: PollClass::Medium,
        scope: Some("esi-contracts.read_character_contracts.v1"),
    },
    Endpoint {
        key: "market_orders",
